# Generated by Django 3.0.3 on 2020-09-30 22:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Tct',
            fields=[
                ('tk_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='acq.Tk')),
                ('Lt0', models.FloatField(default=0.0, null=True)),
                ('Lt1', models.FloatField(default=0.0, null=True)),
                ('Tov_1', models.FloatField(default=0.0, null=True)),
                ('Tov_2', models.FloatField(default=0.0, null=True)),
